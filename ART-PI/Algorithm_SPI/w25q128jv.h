...
#define W25Q128JV_ERASE_BLOCK (0xd8)
#define W25Q128JV_ERASE_CHIP (0xc7)
...
extern int SPI_W25Q128JV_EraseBlock(uint32_t BlackAddress);
extern int SPI_W25Q128JV_EraseChip(void);
extern int SPI_W25Q128JV_Read(uint8_t *pData, uint32_t ReadAddr, uint32_t Size);
extern int SPI_W25Q128JV_PageProgram(uint8_t *pData, uint32_t WriteAddr, uint32_t Size);
