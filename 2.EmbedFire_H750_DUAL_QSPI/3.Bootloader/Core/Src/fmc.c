...
#define REFRESH_COUNT                    ((uint32_t)918)   /* SDRAM refresh counter (120Mhz FMC clock) */
...
#define SDRAM_MODEREG_WRITE_MODE_BURST_READ_BURST_WRITE     ((uint16_t)0x0000)
#define SDRAM_MODEREG_WRITEBURST_BURST_READ_SINGLE_WRITE    ((uint16_t)0x0200)
/* USER CODE END 0 */
  ...
  */
  ...
  /* USER CODE BEGIN FMC_Init 2 */
    ...
    tmpmrd = (uint32_t)SDRAM_MODEREG_BURST_LENGTH_1          | \
             ...
             SDRAM_MODEREG_WRITEBURST_BURST_READ_SINGLE_WRITE;
