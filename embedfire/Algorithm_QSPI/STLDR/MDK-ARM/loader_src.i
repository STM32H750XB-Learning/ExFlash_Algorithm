# 1 "../Core/Src/Loader_Src.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 392 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Core/Src/Loader_Src.c" 2
...
# 3 "../Core/Src/Loader_Src.c" 2
# 1 "../Core/Inc\\quadspi.h" 1
# 35 "../Core/Inc\\quadspi.h"
...
# 4 "../Core/Src/Loader_Src.c" 2
# 1 "../Core/Inc\\gpio.h" 1
# 39 "../Core/Inc\\gpio.h"
void MX_GPIO_Init(void);
# 5 "../Core/Src/Loader_Src.c" 2
...
# 7 "../Core/Src/Loader_Src.c" 2

extern void SystemClock_Config(void);
# 21 "../Core/Src/Loader_Src.c"
int Init (void)
{
 __disable_irq();
 SystemInit();
 ...
 HAL_DeInit();
    ...
    hqspi.Instance = ((QUADSPI_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x5000UL));
...
# 147 "../Core/Src/Loader_Src.c"
int MassErase (void)
{
 W25QXX_Erase_Chip();
 return 1;
}
# 165 "../Core/Src/Loader_Src.c"
