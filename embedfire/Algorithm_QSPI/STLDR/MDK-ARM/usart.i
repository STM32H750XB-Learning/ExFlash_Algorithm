...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL)))
  {
    ...
    PeriphClkInitStruct.PeriphClockSelection = ((uint64_t)(0x00000001U));
    PeriphClkInitStruct.Usart16ClockSelection = (0x00000000U);
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB2ENR) |= ((0x1UL << (4U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB2ENR) & ((0x1UL << (4U)))); ((void)(tmpreg)); } while(0);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0400)|((uint16_t)0x0200);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) (((0x40000000UL) + 0x00010000UL) + 0x1000UL)))
  {
    ...
    (((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->APB2ENR) &= ~ ((0x1UL << (4U)));





    HAL_GPIO_DeInit(((GPIO_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x0000UL)), ((uint16_t)0x0400)|((uint16_t)0x0200));
