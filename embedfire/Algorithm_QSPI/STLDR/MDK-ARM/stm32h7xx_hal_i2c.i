...
# 324 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c" 2
# 414 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
                                         ...
                                         uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (I2C_WaitOnFlagUntilTimeout(hi2c, (0x1UL << (4U)), RESET, Timeout, tickstart) != HAL_OK)
    {
...
# 2422 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Mem_Write(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress,
                                    uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint32_t tickstart;
...
# 2848 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
    I2C_Enable_IRQ(hi2c, ((uint16_t)(0x0001U) | (uint16_t)(0x0002U)));
...
# 3814 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Transmit_IT(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size,
                                                uint32_t XferOptions)
{
...
# 3914 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size,
                                                 uint32_t XferOptions)
{
...
# 4497 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
void HAL_I2C_EV_IRQHandler(I2C_HandleTypeDef *hi2c)
{
...
# 5701 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_RequestMemoryRead(I2C_HandleTypeDef *hi2c, uint16_t DevAddress,
                                               uint16_t MemAddress, uint16_t MemAddSize, uint32_t Timeout,
                                               uint32_t Tickstart)
{
...
# 6737 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Flag, FlagStatus Status,
                                                    uint32_t Timeout, uint32_t Tickstart)
{
...
# 6771 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static HAL_StatusTypeDef I2C_WaitOnTXISFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout,
                                                        uint32_t Tickstart)
{
...
# 7067 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c"
static void I2C_TransferConfig(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t Size, uint32_t Mode,
                               uint32_t Request)
{
  ...
  uint32_t tmp = ((uint32_t)(((uint32_t)DevAddress & (0x3FFUL << (0U))) | (((uint32_t)Size << (16U)) & (0xFFUL << (16U))) | (uint32_t)Mode | (uint32_t)Request) & (~0x80000000U));
