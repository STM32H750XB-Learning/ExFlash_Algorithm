...
# 88 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash.c" 2
...
HAL_StatusTypeDef HAL_FLASH_Program(uint32_t TypeProgram, uint32_t FlashAddress, uint32_t DataAddress)
{
  ...
  if((((FlashAddress) >= (0x08000000UL)) && ((FlashAddress) <= (0x0801FFFFUL))))
...
# 1022 "../Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash.c"
  while((((((FLASH_TypeDef *) (((0x40000000UL) + 0x12000000UL) + 0x2000UL))->SR1) & ((bsyflag))) == (bsyflag)))
  {
